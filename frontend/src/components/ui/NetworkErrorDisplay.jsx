...
const NetworkErrorDisplay = ({ title, message }) => {
  return (
    <div className='min-h-[calc(100vh-4rem)] flex flex-col items-center justify-center p-4 text-center bg-gradient-to-br from-blue-100 to-purple-100 dark:from-gray-900 dark:to-indigo-900'>
      ...
      <h1 className='text-3xl sm:text-5xl font-extrabold text-indigo-700 dark:text-indigo-400 mb-3 text-center tracking-tight'>
        {title || "Connection Lost!"}
      </h1>
      
      {/* 3. Paragraph font size is smaller on mobile screens */}
      <p className='text-base sm:text-xl text-gray-600 dark:text-gray-300 mb-6 sm:mb-8 text-center max-w-xl leading-relaxed'>
